    ...
    var tranSprite = (function(window,document){
        ...
        animate.prototype = {
            ...
            _transDirect:function(){
                var me = this;
                var regRes = me.trigger.style.transform.match(/[+-]?\d+/gi) || ["0","0"];
                if(me.fx.s == "x"){
                    pos.fixedP = +regRes[1];
                    pos.endP = +regRes[0];
                }
            ...
            move:function(endX,endY,duration,ease){
                var self = this;
                var el = self.trigger;
                el.style.WebkitTransition = duration ? "transform "+duration+"ms "+ease : "";
                el.style.WebkitTransform = 'translate3D(' +endX + 'px, '+endY+'px,0)';
            },
            ...
            _touchmove:function(){
                ...
                return function(e){
                    ...
                    pos.oldE = pos.newE;
                    pos.v = delta/(e.timeStamp - pos.oldTime);
            ...
            _touchend:function(){
                ...
                return function(e){
                    ...
                    me.move(pos[pos[me.fx.s][1]],pos[pos[me.fx.s][2]],duration,"ease");
                    pos.oldE = pos.newE;
                }
